...
function FloorCanvas({ tables,guests,groups,assignments,dispatch,dragGuest,setDragGuest,handleSeatDrop,handleSeatClick,selectedSeat,setSelectedSeat,expandedTable,setExpandedTable,handleTableClick,highlightedGuest,highlightedTable,getGC,getGuestAtSeat,canvasWrapRef,isMobile,unseatedCount,assignedCount,bgStyle,dispatch_,t,undoToast }) {
  ...
  function onTouchMove(e){
    e.preventDefault();
    if(e.touches.length===1&&panning&&panStart){
      const t=e.touches[0];
  ...
  function onTouchEnd(){setPanning(false);setPanStart(null);lastPinchDist.current=null;}
  ...
  return (
    <>
      ...
      {isSelected&&(
        <div
          ...
          <div
            ...
            style={{ display:"flex",alignItems:"center",gap:4,padding:"2px 8px",borderRadius:6,cursor:"ew-resize",color:"#ddd",fontSize:11,fontWeight:500,fontFamily:"'DM Sans',sans-serif",userSelect:"none",WebkitUserSelect:"none" }}
          ...
          <div
            ...
            style={{ display:"flex",alignItems:"center",gap:4,padding:"2px 8px",borderRadius:6,cursor:"se-resize",color:"#ddd",fontSize:11,fontWeight:500,fontFamily:"'DM Sans',sans-serif",userSelect:"none",WebkitUserSelect:"none" }}
            title="Resize (drag)">
            <span style={{ fontSize:13 }}>⤡</span>
          ...
          <div
            ...
            style={{ display:"flex",alignItems:"center",padding:"2px 6px",borderRadius:6,cursor:"pointer",color:"#f87171",fontSize:13,fontWeight:700 }}
            title="Delete">
            ×
          </div>
        </div>
      ...
      <div
        ...
        <svg width={svgW} height={svgH} style={{ overflow:"visible",pointerEvents:"all" }} onMouseDown={onStartDrag}>
          <defs>
